...
main:
    ...
    la s0 m0
    addi s1 x0 3 # number of rows m0 (height)
    addi s2 x0 3 #number of columns m0 (width)
    la s3 m1
    addi s4 x0 3 #number of rows m1 (height)
    addi s5 x0 3 #number of columns m1 (width)
    la s6 d
